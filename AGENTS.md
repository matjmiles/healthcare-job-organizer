...
2. **Architectural Education Filtering Improvements**: 
   ...
   - **Inclusive Bachelor's Logic**: Jobs included if bachelor's degree mentioned in ANY way (required, preferred, desired, plus, etc.)
   - **Pipeline Filtering**: Strict education filtering applied at data collection level (Python)
...
- **Pipeline Jobs**: 16 (from 1,499 analyzed with inclusive bachelor's filtering)
- **Manual Jobs**: 24 (hand-selected from Indeed HTML)
- **Final Excel Output**: 40 jobs total (16 pipeline + 24 manual)
- **Latest Excel File**: `output/jobs_consolidated_2025-12-29_19-18-27.xlsx`
- **Data Sources**: 
