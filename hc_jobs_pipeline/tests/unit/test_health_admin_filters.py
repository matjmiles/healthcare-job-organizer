...
from hc_jobs_pipeline.run_collect import looks_like_health_admin
...
class TestHealthAdminFilters:
    ...
    def __init__(self):
        ...
        self.test_cases = [
            ...
            ("Healthcare Operations Coordinator", "Coordinate patient care operations in hospital setting. Bachelor's degree required.", True, "passes", "Healthcare operations role"),
            ("Medical Billing Specialist", "Process insurance claims and patient billing. Bachelor's degree preferred.", True, "passes", "Medical billing role"),
            ("Practice Administrator", "Manage medical practice operations and staff. Bachelor's degree in healthcare administration.", True, "passes", "Practice administration"),
            ("Health Information Manager", "Manage patient records and health information systems. Bachelor's degree required.", True, "passes", "Health information management"),
            ...
            ("Hospital Administrator", "Oversee hospital operations and strategic planning. Bachelor's degree required.", True, "passes", "Hospital administration"),
    ...
    def print_summary(self):
        ...
        if self.failed == 0:
            ...
            print(f"WARNING: {self.failed} test(s) failed - review filtering logic")
...
def test_keyword_detection():
    ...
    keyword_tests = [
        ("Revenue Cycle Manager", "Manage revenue cycle operations. Bachelor's degree required.", True, "Revenue cycle keyword"),
        ("Quality Assurance Specialist", "Healthcare quality improvement. Bachelor's degree preferred.", True, "Quality assurance healthcare"),
        ("Compliance Officer", "Ensure regulatory compliance in healthcare. Bachelor's degree required.", True, "Healthcare compliance"),
